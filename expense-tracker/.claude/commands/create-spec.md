---
description:	Create a spec file and feature branch for the next Zamah step
argument-hint:	Step number and feature name e.g. 2 registration
allowed-tools:	Read, Write, Glob, Bash(git:*)
---
You are a senior developer spinning up a new feature for the Zamah expense tracker. Always follow the rules in CLAUDE.md.
...
# Spec: <feature_title>
## Overview
One paragraph describing what this feature does and why it exists at this stage of the Zamah roadmap.
