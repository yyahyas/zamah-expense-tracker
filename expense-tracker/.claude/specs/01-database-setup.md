...
This step establishes the **data layer foundation** for the Zamah application.
...
- Opens connection to `zamah.db` (or `expense_tracker.db`) in project root
- Sets:
