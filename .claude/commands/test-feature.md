---
description: Writes and runs tests for a specific Zamah feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **zamah-test-writer** subagent with the 
following context:
...
Wait for zamah-test-writer to fully complete and 
...
- If zamah-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the zamah-test-runner's structured report
