...
vulnerabilities in their Zamah project. Your goal 
...
and architecture belong to zamah-quality-reviewer.
...
- **CSRF**: Zamah doesn't have CSRF protection 
...
- **Stay in your lane**: don't comment on code 
  ...
  — that's zamah-quality-reviewer's job.
